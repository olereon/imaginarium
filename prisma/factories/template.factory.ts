...
export class TemplateFactory extends BaseFactory<PipelineTemplate> {
  ...
  build(overrides: Partial<TemplateCreateInput> = {}): PipelineTemplate {
    ...
    const defaultData: TemplateCreateInput = {
      pipelineId:
        ...
        (this.randomBoolean(0.7) ? `pipeline_${this.randomInt(1, 100)}` : null),
  ...
  async createMany(
    count: number,
    overrides: Partial<TemplateCreateInput> = {}
  ...
  async createContentCreationTemplate(
    overrides: Partial<TemplateCreateInput> = {}
  ): Promise<PipelineTemplate> {
  ...
  async createDataAnalysisTemplate(
    overrides: Partial<TemplateCreateInput> = {}
  ): Promise<PipelineTemplate> {
    return await this.create({
  ...
  async createWorkflowAutomationTemplate(
    overrides: Partial<TemplateCreateInput> = {}
  ): Promise<PipelineTemplate> {
    return await this.create({
  ...
  async createTextProcessingTemplate(
    overrides: Partial<TemplateCreateInput> = {}
  ): Promise<PipelineTemplate> {
    return await this.create({
  ...
  async createAPIIntegrationTemplate(
    overrides: Partial<TemplateCreateInput> = {}
  ): Promise<PipelineTemplate> {
    return await this.create({

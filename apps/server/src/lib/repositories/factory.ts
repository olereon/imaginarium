...
export class RepositoryFactory implements IRepositoryFactory {
   ...
   */
  async withTransaction<T>(operation: (context: TransactionContext) => Promise<T>): Promise<T> {
...
export const getPipelineRepository =
  repositoryFactory.getPipelineRepository.bind(repositoryFactory);
export const getExecutionRepository =
  repositoryFactory.getExecutionRepository.bind(repositoryFactory);

...
export class EnhancedUserRepository extends BaseRepository<User, CreateUserInput, UpdateUserInput> 
  ...
  async validate(data: CreateUserInput | UpdateUserInput): Promise<{ isValid: boolean; errors: string[] }> {
    const errors: string[] = []
    ...
    if ('email' in data && data.email) {
      ...
      if ('passwordHash' in data) { // This is a create operation
  ...
  async findByEmail(email: string, includeDeleted = false, context?: TransactionContext): Promise<User | null> {
    return this.executeWithMetrics('findByEmail', async () => {
  ...
  async findByEmailActive(email: string, context?: TransactionContext): Promise<User | null> {
    return this.executeWithMetrics('findByEmailActive', async () => {
      const model = this.getModel(context)
  ...
  async findByPasswordResetToken(token: string, context?: TransactionContext): Promise<User | null> {
    return this.executeWithMetrics('findByPasswordResetToken', async () => {
      const model = this.getModel(context)
      return await model.findFirst({
        where: {
  ...
  async findByEmailVerificationToken(token: string, context?: TransactionContext): Promise<User | null> {
    return this.executeWithMetrics('findByEmailVerificationToken', async () => {
      const model = this.getModel(context)
      return await model.findFirst({
        where: {
  ...
  async updateLastLogin(id: string, context?: TransactionContext): Promise<User> {
    return this.executeWithMetrics('updateLastLogin', async () => {
      const model = this.getModel(context)
  ...
  async resetPassword(id: string, token: string, expiresAt: Date, context?: TransactionContext): Promise<User> {
  ...
  async clearPasswordResetToken(id: string, context?: TransactionContext): Promise<User> {
    return this.executeWithMetrics('clearPasswordResetToken', async () => {
      const model = this.getModel(context)
      const user = await model.update({
        where: { id },
        data: {
  ...
  async updatePassword(id: string, passwordHash: string, context?: TransactionContext): Promise<User> {
    return this.executeWithMetrics('updatePassword', async () => {
      const model = this.getModel(context)
      const user = await model.update({
        where: { id },
        data: {
  ...
  async verifyEmail(id: string, context?: TransactionContext): Promise<User> {
    return this.executeWithMetrics('verifyEmail', async () => {
      const model = this.getModel(context)
      const user = await model.update({
        where: { id },
        data: {
  ...
  async setEmailVerificationToken(id: string, token: string, expiresAt: Date, context?: TransactionContext): Promise<User> {
    return this.executeWithMetrics('setEmailVerificationToken', async () => {
      const model = this.getModel(context)
      const user = await model.update({
        where: { id },
        data: {
  ...
  async clearEmailVerificationToken(id: string, context?: TransactionContext): Promise<User> {
    return this.executeWithMetrics('clearEmailVerificationToken', async () => {
      const model = this.getModel(context)
      const user = await model.update({
        where: { id },
        data: {
  ...
  async enableTwoFactor(id: string, secret: string, context?: TransactionContext): Promise<User> {
    return this.executeWithMetrics('enableTwoFactor', async () => {
      const model = this.getModel(context)
      const user = await model.update({
        where: { id },
        data: {
  ...
  async disableTwoFactor(id: string, context?: TransactionContext): Promise<User> {
    return this.executeWithMetrics('disableTwoFactor', async () => {
      const model = this.getModel(context)
      const user = await model.update({
        where: { id },
        data: {
  ...
  async activate(id: string, context?: TransactionContext): Promise<User> {
    return this.executeWithMetrics('activate', async () => {
      const model = this.getModel(context)
      const user = await model.update({
        where: { id },
        data: { isActive: true }
  ...
  async deactivate(id: string, context?: TransactionContext): Promise<User> {
    return this.executeWithMetrics('deactivate', async () => {
      const model = this.getModel(context)
      const user = await model.update({
        where: { id },
        data: { isActive: false }
  ...
  async changeRole(id: string, role: UserRole, context?: TransactionContext): Promise<User> {
    return this.executeWithMetrics('changeRole', async () => {
      const model = this.getModel(context)
      const user = await model.update({
        where: { id },
        data: { role }
  ...
  async findWithSessions(id: string, context?: TransactionContext): Promise<UserWithRelations | null> {
    return this.executeWithMetrics('findWithSessions', async () => {
      const model = this.getModel(context)
  ...
  async findWithApiKeys(id: string, context?: TransactionContext): Promise<UserWithRelations | null> {
    return this.executeWithMetrics('findWithApiKeys', async () => {
      const model = this.getModel(context)
      return await model.findUnique({
        where: { id },
        include: {
  ...
  async findWithPipelines(id: string, context?: TransactionContext): Promise<UserWithRelations | null> {
    return this.executeWithMetrics('findWithPipelines', async () => {
      const model = this.getModel(context)
      return await model.findUnique({
        where: { id },
        include: {
  ...
  async findWithExecutions(id: string, context?: TransactionContext): Promise<UserWithRelations | null> {
    return this.executeWithMetrics('findWithExecutions', async () => {
      const model = this.getModel(context)
      return await model.findUnique({
        where: { id },
        include: {
  ...
  async findWithFiles(id: string, context?: TransactionContext): Promise<UserWithRelations | null> {
    return this.executeWithMetrics('findWithFiles', async () => {
      const model = this.getModel(context)
      return await model.findUnique({
        where: { id },
        include: {
  ...
  async findByRole(role: UserRole, context?: TransactionContext): Promise<User[]> {
    return this.executeWithMetrics('findByRole', async () => {
  ...
  async getUserStats(userId: string, context?: TransactionContext): Promise<UserStats> {
    return this.executeWithMetrics('getUserStats', async () => {
  ...
  async createMany(data: CreateUserInput[], context?: TransactionContext): Promise<BulkOperationResult> {
    return this.executeWithMetrics('createMany', async () => {
      const results: Array<{ success: boolean; item?: CreateUserInput; error?: string; index: number }> = []
  ...
  async updateMany(
    ...
    return this.executeWithMetrics('updateMany', async () => {
      const model = this.getModel(context)
  ...
  async deleteMany(
    ...
    return this.executeWithMetrics('deleteMany', async () => {
      const model = this.getModel(context)
  ...
  async bulkUpdateRole(userIds: string[], role: UserRole, context?: TransactionContext): Promise<BulkOperationResult> {
  ...
  async bulkActivate(userIds: string[], context?: TransactionContext): Promise<BulkOperationResult> {
    return this.updateMany(
      { id: { in: userIds } },
      { isActive: true },
      context
  ...
  async bulkDeactivate(userIds: string[], context?: TransactionContext): Promise<BulkOperationResult> {
    return this.updateMany(
      { id: { in: userIds } },
      { isActive: false },
      context
  ...
  async checkExecutionLimit(userId: string, context?: TransactionContext): Promise<{ 
    current: number
    limit: number
    canExecute: boolean
  }> {
    return this.executeWithMetrics('checkExecutionLimit', async () => {
      const model = this.getModel(context)
      const user = await model.findUnique({ where: { id: userId } })
  ...
  async checkPipelineLimit(userId: string, context?: TransactionContext): Promise<{ 
    current: number
    limit: number
    canCreate: boolean
  }> {
    return this.executeWithMetrics('checkPipelineLimit', async () => {
      const model = this.getModel(context)
      const user = await model.findUnique({ where: { id: userId } })
  ...
  async aggregate(options: any, context?: TransactionContext): Promise<any> {
    return this.executeWithMetrics('aggregate', async () => {
      const model = this.getModel(context)
  ...
  async cleanupInactiveUsers(daysInactive: number, context?: TransactionContext): Promise<number> {
    return this.executeWithMetrics('cleanupInactiveUsers', async () => {
  ...
  async exportUserData(userId: string, context?: TransactionContext): Promise<any> {
    return this.executeWithMetrics('exportUserData', async () => {
      const userWithRelations = await this.findById(userId, {
        include: {
          sessions: true,
          apiKeys: true,
          pipelines: true,
  ...
  async importUserData(data: any, context?: TransactionContext): Promise<User> {
    return this.executeWithMetrics('importUserData', async () => {

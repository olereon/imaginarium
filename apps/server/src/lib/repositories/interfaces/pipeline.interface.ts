...
export interface IPipelineRepository
  extends ISoftDeleteRepository<Pipeline, CreatePipelineInput, UpdatePipelineInput> {
  ...
  clone(
    id: string,
    userId: string,
    options?: { name?: string; includeVersions?: boolean },
    context?: TransactionContext
  ): Promise<Pipeline>;
  ...
  exportPipeline(
    id: string,
    options?: { includeVersions?: boolean; includeRuns?: boolean },
    context?: TransactionContext
  ): Promise<any>;

...
export interface IFileRepository
  extends IBaseRepository<FileUpload, CreateFileUploadInput, UpdateFileUploadInput> {
  ...
  findFileReferencesByTaskId(
    taskId: string,
    context?: TransactionContext
  ): Promise<FileReference[]>;
  findFileReferencesByFileId(
    fileId: string,
    context?: TransactionContext
  ): Promise<FileReference[]>;
  findFileReferencesByArtifactId(
    artifactId: string,
    context?: TransactionContext
  ): Promise<FileReference[]>;
  ...
  // Relationships
  findFileWithRelations(
    id: string,
    context?: TransactionContext
  ): Promise<FileWithRelations | null>;
  findArtifactWithRelations(
    id: string,
    context?: TransactionContext

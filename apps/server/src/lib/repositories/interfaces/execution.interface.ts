...
export interface IExecutionRepository
  extends IBaseRepository<PipelineRun, CreatePipelineRunInput, UpdatePipelineRunInput> {
  ...
  findWithArtifacts(
    id: string,
    context?: TransactionContext
  ): Promise<ExecutionWithRelations | null>;
  findTaskWithLogs(
    id: string,
    context?: TransactionContext
  ): Promise<TaskExecutionWithRelations | null>;

  // Search and filtering
  searchExecutions(
    options: ExecutionSearchOptions,
    context?: TransactionContext
  ): Promise<PipelineRun[]>;
  findExecutionsInDateRange(
    from: Date,
    to: Date,
    context?: TransactionContext
  ): Promise<PipelineRun[]>;
  findLongRunningExecutions(
    minDuration: number,
    context?: TransactionContext
  ): Promise<PipelineRun[]>;
